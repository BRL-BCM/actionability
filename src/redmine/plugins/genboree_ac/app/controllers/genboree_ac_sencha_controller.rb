...
class GenboreeAcSenchaController < ApplicationController
  class GenboreeAcSenchaControllerError < StandardError; end
  ...
  rescue GenboreeAcSenchaControllerError => e
    $stderr.puts "ERROR - #{__method__}() => Exception! #{e.class} - #{e.message}\n#{e.backtrace.join("\n")}\n\n"
  ...
  def get_project_directory
    @project_directory ||= Setting.plugin_genboree_ac['path'].to_s
